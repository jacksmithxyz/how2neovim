...
Sometimes you won’t see any noticeable difference in your snytax highlighting until you install a language server (which we will do in the [LSP](/tree-sitter-and-lsp/introduction-to-lsp) section).
</Aside>
...
There is more information on setting up themes in the [colorscheme](/plugins/colorschemes) section.
